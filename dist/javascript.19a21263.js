...
function () {
  function Player(node) {
    ...
    this.bind();
    this.lyricsArr = [];
    this.lyricIndex = -1; //https://jirengu.github.io/data-mock/huawei-music/music-list.json
  }
  ...
  _createClass(Player, [{
    ...
    value: function bind() {
      ...
      this.$('.btn-pre').onclick = function () {
        self.currentIndex = (self.songList.length + self.currentIndex - 1) % self.songList.length; // self.audio.src=this.songList[this.currentIndex].url
      ...
      this.$('.btn-next').onclick = function () {
        self.currentIndex = (self.songList.length + self.currentIndex + 1) % self.songList.length; // this.audio.src=this.songList[this.currentIndex].url
      ...
      this.$('.bar').onclick = function (e) {
        var bar = self.$('.bar');
        var move = e.clientX - bar.offsetLeft;
        var percent = move / bar.offsetWidth;
        console.log(percent); // self.audio.currentTime = self.audio.duration * percent
      };
    ...
    value: function locateLyric() {
      ...
      var nextTime = this.lyricsArr[this.lyricIndex + 1][0];
    ...
    key: "setLyricsToCenter",
    value: function setLyricsToCenter(node) {
    ...
    key: "formateTime",
    value: function formateTime(secondesTatal) {
      var minutes = parseInt(secondesTatal / 60);
      minutes = minutes >= 10 ? '' + minutes : '0' + minutes;
      var seconds = parseInt(secondesTatal % 60);
